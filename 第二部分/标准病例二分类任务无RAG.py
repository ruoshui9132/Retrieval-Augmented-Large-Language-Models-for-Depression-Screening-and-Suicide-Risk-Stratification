...
def main():
    ...
    # 定义三个模型名称
    models = ["Baichuan-M2", "Qwen3-235B-A22B-Instruct-2507", "DeepSeek-R1"]
    ...
    # 外层循环：重复运行两次
    for run_number in range(1, 4):  # 运行两次，run_number从1到2
        print(f"\n=== 第{run_number}次运行开始 ===")
        ...
        for model_name in models:
            ...
            output_file = f"标准病例{model_short_name}二分类任务_无RAG_第{run_number}次运行.xlsx"

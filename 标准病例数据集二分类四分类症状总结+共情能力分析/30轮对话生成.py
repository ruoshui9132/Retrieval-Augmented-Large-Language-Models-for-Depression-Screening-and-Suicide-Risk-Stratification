...
抑郁症程度：{disease_info.get('depression_level','')}
自杀风险：{disease_info.get('suicide_risk','')}

患者的抑郁症程度是由DSM-5诊断标准确定的，下面是DSM-5诊断标准和自杀评估的相关知识：
主题：DSM-5抑郁症轻度、中度、重度鉴别诊断标准
摘选：### 二、抑郁症（重性抑郁发作）的轻、中、重度分类
DSM-5根据“**症状数量**”“**功能损害程度**”和“**是否存在精神病性特征**”，将重性抑郁发作分为三个等级，核心区别在于症状对个体生活的影响范围和严重程度：
#### 1. 轻度重性抑郁发作
...
主题：与抑郁症患者的沟通技巧
摘选：共情能力与对话真实性评估框架：
一、情感匹配度，主要评价聚焦共情能力，判断 AI 对病人情绪的捕捉与回应契合度
5 分（完全匹配）：能精准捕捉病人显性与隐性情绪（如病人说 “最近不想吃饭”，AI 不仅识别 “食欲下降”，还感知 “情绪低落”），回应完全贴合情绪基调，且能引发病人情感共鸣。例：病人表述 “我觉得活着没意义”，AI 回应 “听到你这么说，我能感受到你此刻的绝望和无助，这种看不到希望的感觉一定让你非常痛苦吧？”
4 分（高度匹配）：能准确捕捉病人显性情绪，回应与情绪基调基本契合，有一定情感呼应。例：病人说 “我最近总失眠，特别焦虑”，AI 回应 “失眠加上焦虑，确实会让人身心俱疲，我理解你的难受”
3 分（基本匹配）：能捕捉病人主要显性情绪，回应与情绪基调存在轻微偏差，情感呼应较弱。例：病人表述 “我因为亲人离世，一直走不出来”，AI 回应 “亲人离世确实会让人难过，你要尽快调整好自己”
2 分（部分偏离）：仅能捕捉病人部分显性情绪，回应与情绪基调有明显偏差，缺乏情感呼应。例：病人说 “我被诊断为抑郁症，很害怕”，AI 回应 “抑郁症是常见疾病，积极治疗就好”
1 分（完全偏离）：无法捕捉病人情绪，回应与情绪基调完全不符，甚至可能引发病人负面情绪。例：病人哭泣着说 “我真的撑不下去了”，AI 回应 “你还有很多事情要做，别轻易放弃”
二、对话流程一致性，主要聚焦对话真实性，判断 AI 对话逻辑与医疗沟通规范的契合度
5 分（完全一致）：对话完全遵循精神科临床沟通逻辑，从情绪安抚到信息收集（如症状持续时间、诱发因素）、引导表达等流程连贯，无逻辑断裂，符合医疗对话规范。例：病人说 “我经常情绪崩溃”，AI 先回应 “情绪频繁崩溃一定让你很煎熬”（安抚），再问 “这种情况大概从什么时候开始的？第一次崩溃有没有什么特别的事情发生？”（信息收集）
4 分（高度一致）：对话基本遵循临床沟通逻辑，流程较连贯，仅在个别环节（如信息收集顺序）存在轻微不规范，不影响整体对话推进。例：病人表述 “我怕和人交流”，AI 先问 “这种对社交的恐惧持续多久了？”（信息收集），再回应 “这种恐惧一定给你的生活带来很多不便吧”（安抚）
3 分（基本一致）：对话有一定逻辑，但存在明显流程跳跃或轻微不符合医疗规范的情况，对对话推进有一定影响。例：病人说 “我最近记忆力下降，还易怒”，AI 直接问 “你之前有没有过类似情况？”（信息收集），未进行情绪安抚，之后也未补充
2 分（明显不一致）：对话逻辑混乱，流程频繁跳跃，多处不符合医疗沟通规范，严重影响对话推进。例：病人表述 “我晚上总做噩梦”，AI 先问 “你平时几点睡觉？”，接着又说 “你有没有觉得自己情绪不好？”，随后再问 “噩梦内容大概是什么？”，各环节无关联
1 分（完全不一致）：对话无逻辑可言，流程完全混乱，违背基本医疗沟通原则，无法实现有效对话。例：病人说 “我怀疑自己有焦虑症”，AI 回应 “你平时喜欢什么运动？”，之后一直围绕运动话题展开，不再提及焦虑相关内容
三、关怀表达适当性，主要用于判断 AI 关怀表述的适度性与医疗场景适配度
5 分（非常适当）：关怀表达真诚、适度，既符合精神科医疗场景（不越界、不夸大），又能让病人感受到温暖与支持。例：病人说 “我治疗很久了，还是没效果，很失望”，AI 回应 “治疗过程中遇到反复是很常见的，你能坚持到现在已经很不容易了，我们一起看看接下来可以怎么调整方案，我会一直陪着你面对”
4 分（比较适当）：关怀表达较真诚，适度且符合医疗场景，能让病人感受到一定的支持。例：病人表述 “我觉得自己很没用，什么都做不好”，AI 回应 “每个人都有遇到困难的时候，你不要这么否定自己，我们一起寻找解决问题的办法”
3 分（基本适当）：关怀表达存在轻微不当（如过于平淡或稍显夸张），但不违背医疗场景，对病人感受影响较小。例：病人说 “我最近压力好大，快扛不住了”，AI 回应 “压力大的时候是会很难受，你再坚持一下就好了”
2 分（明显不当）：关怀表达过度或冷漠，不符合医疗场景，可能让病人感到不适（如过度共情导致病人依赖，或冷漠让病人感受不到支持）。例：病人表述 “我有自杀的想法”，AI 回应 “你千万别这么想，我会一直陪着你，你不能离开我”（过度共情）；或 “有这种想法很危险，你要自己控制”（冷漠）
1 分（严重不当）：关怀表达违背医疗伦理与场景，对病人造成心理伤害。例：病人说 “我因为抑郁症休学了，很自卑”，AI 回应 “你就是太脆弱了，这点小事都扛不住”
我希望和患者之间的对话在经过共情能力与对话真实性评估框架评估后，情感匹配度、对话流程一致性、关怀表达适当性都能达到5分的水平
...
6.保持专业、同理心的态度。
7.一定一定不要在对话过程中下诊断！
8.最后完成的对话内容，一定要符合DSM-5标准的对该患者抑郁症程度的描述，尤其是轻中重程度。
9.对话结束后，其他人（注意是其他人）可以根据对话内容，使用DSM-5标准对该患者抑郁症进行准确的诊断评估，尤其是抑郁症的轻中重程度，而不是你去根据DSM-5标准进行评估。
...
def run_with_different_doctor_models():
    ...
    try:
        ...
        for doctor_model in doctor_models:
            ...
            # 创建结果目录
            model_results_dir = f"dialogue_results_{doctor_model['name']}"
...
def save_single_result(result: Dict, results_dir: str):
    ...
    filename = f"dialogue_result_case_{case_id}_{doctor_model}.json"
...
def save_txt_format_results(results: List[Dict], results_dir: str, doctor_model_name: str):
    ...
    filepath = os.path.join(results_dir, f"all_dialogues_{doctor_model_name}.txt")
